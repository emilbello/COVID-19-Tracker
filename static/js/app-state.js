...
// function bubbleChart(info, info2) {
    
//     // d3.json("/covid_data").then((meta) => {
        
//     //     // Grab selected Dataset from samples using state ID from dropdown
//     //     var selectedData = meta.filter(x => x.state_abbr === info);
//     //     console.log(selectedData);
//     //     var selectedData2 = meta.filter(x => x.state_abbr === info2);
//     //     console.log(selectedData2);
